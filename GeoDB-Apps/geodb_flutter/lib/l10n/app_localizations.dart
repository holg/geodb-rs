...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Enter city, state, or country name'**
  ...
  /// In en, this message translates to:
  /// **'Nearest to Berlin'**
  String get nearestToBerlin;

  /// Radius search button label
  ///
  /// In en, this message translates to:
  /// **'50km Radius'**
  String get radiusSearch;
