...
PACKAGE_SWIFT="$ROOT_DIR/GeoDB-Apps/SPM-GeoDBKit/Package.swift"
...
RELEASE_URL="$REPO_URL/releases/download/$VERSION/GeodbKit-$VERSION-universal.zip"
...
echo "   cd GeoDB-Apps/SPM-GeoDBKit"
echo "   swift package resolve"
echo "   swift build"
echo ""
echo "3. Commit the changes:"
echo "   git add GeoDB-Apps/SPM-GeoDBKit/Package.swift"
