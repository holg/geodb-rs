...
RELEASE_ZIP="$ROOT_DIR/releases/GeodbKit-$VERSION-universal.zip"
...
\`\`\`swift
dependencies: [
    .package(url: \"https://github.com/YOUR_ORG/geodb-rs.git\", from: \"${VERSION#v}\")
]
\`\`\`
...
See [README](https://github.com/YOUR_ORG/geodb-rs/blob/main/GeoDB-Apps/SPM-GeoDBKit/README.md) for usage examples.
...
echo ""
echo "View release:"
echo "  ${BLUE}https://github.com/YOUR_ORG/geodb-rs/releases/tag/$VERSION${NC}"
echo ""
echo "Checksum: $CHECKSUM"
echo ""
echo "Next: Commit Package.swift update"
echo "  ${BLUE}git add GeoDB-Apps/SPM-GeoDBKit/Package.swift${NC}"
